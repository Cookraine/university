...
object Program {
  def main(args: Array[String]) = {
    ...
    tchr1.addCourse(Course("Data Science", CourseCategory.SWE, new Token(95, "SP"), 1, 10))
    tchr1.addCourse(Course("Software Architecture", CourseCategory.SWE, new Token(100, "SP"), 4, 12))

    var tchr2 = new Teacher("Iryna", 'F', 47, 5, new Token(200, "SP"), addr1)
    tchr2.addCourse(Course("C++", CourseCategory.Programming, new Token(70, "SP"), 1, 10))
    tchr2.addCourse(Course("Rust", CourseCategory.Programming, new Token(80, "SP"), 3, 15))

    var tchr3 = new Teacher("Tetiana", 'F', 35, 5, new Token(200, "SP"), addr2)
    tchr3.addCourse(Course("PostreSQL", CourseCategory.Database, new Token(80, "SP"), 2, 10))
    tchr3.addCourse(Course("Docker", CourseCategory.DevOps, new Token(90, "SP"), 4, 12))
